...
#define Echo GPIO_Pin_1	//HC-SR04模块的Echo脚接GPIOB5
#define Trig GPIO_Pin_0		//HC-SR04模块的Trig脚接GPIOB5

uint64_t Dis_time=0;			//声明变量，用来计时
...
void HC_SR04_Init(void)
{
	...
	GPIO_Init(GPIOB,&GPIO_InitStructure);					//初始化GPIOB
	GPIO_WriteBit(GPIOB,GPIO_Pin_0,0);						//输出低电平
	Delay_Us(15);											//延时15微秒
}
