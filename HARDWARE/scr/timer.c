...
void TIM3_ENABLE(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Period =  10 - 1; 	          //设置自动重装载值
	TIM_TimeBaseInitStructure.TIM_Prescaler=72-1;               //设置定时器预分频数
